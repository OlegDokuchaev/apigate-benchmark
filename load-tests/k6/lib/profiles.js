...
export const profiles = {
    ...
    steady: () => ({
        ...
        rate: intEnv('STEADY_RPS', 500),
        timeUnit: '1s',
        duration: __ENV.STEADY_DURATION || '2m',
        preAllocatedVUs: intEnv('STEADY_VUS', 200),
        maxVUs: intEnv('STEADY_MAX_VUS', 1000),
    }),
    ...
    ramp: () => ({
        ...
        timeUnit: '1s',
        preAllocatedVUs: intEnv('RAMP_VUS', 500),
        maxVUs: intEnv('RAMP_MAX_VUS', 2000),
        stages: [
            { duration: __ENV.RAMP_DURATION || '5m', target: intEnv('RAMP_END', 2000) },
        ],
    }),
    ...
    stress: () => ({
        executor: 'constant-arrival-rate',
        rate: intEnv('STRESS_RPS', 2500),
        timeUnit: '1s',
        duration: __ENV.STRESS_DURATION || '1m',
        preAllocatedVUs: intEnv('STRESS_VUS', 1000),
        maxVUs: intEnv('STRESS_MAX_VUS', 3000),
    }),
};
